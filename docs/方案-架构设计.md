...
```
agv/{agvCode}/status          # 小车 → 服务器：状态上报
agv/{agvCode}/task/assign     # 服务器 → 小车：任务下发
agv/{agvCode}/task/cancel     # 服务器 → 小车：取消任务
agv/{agvCode}/task/progress   # 小车 → 服务器：任务进度
agv/{agvCode}/command         # 服务器 → 小车：控制指令
agv/{agvCode}/exception       # 小车 → 服务器：异常上报
```
